...
namespace fpp::VideoFilter::DrawText {
    ...
    struct Font {
        ...
        */
         ...
         *  no_autohint
        */
        std::string ft_load_flags { "default" };
    ...
    struct Box {
        ...
        */
        std::string boxcolor { "white" };

        /*
         * Set the width of the border to be drawn
         * around the box using border_color
        */
        std::string borderw { "0" };
    ...
    struct Shadow {
        ...
        */
        std::string shadowx { "0" };
        std::string shadowy { "0" };

        /*
         * The color to be used for drawing a shadow
         * behind the drawn text
        */
        std::string shadowcolor { "black" };
